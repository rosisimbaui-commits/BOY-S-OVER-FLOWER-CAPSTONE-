...
<div class="sidebar">
    ...
    <nav>
        ...
        <a href="batch_history.php" class="nav-link <?= $currentPage === 'batch_history.php' ? 'active' : '' ?>">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            <div class="sidebar-avatar"><?= strtoupper(substr($_SESSION['admin_name'] ?? 'A', 0, 1)) ?></div>
            <div>
                <div class="sidebar-username"><?= htmlspecialchars($_SESSION['admin_name'] ?? 'Admin') ?></div>
